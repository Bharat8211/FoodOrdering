...
public class Italian extends JFrame{
	...
	JFrame frame;
	public Italian(HashMap<String,Integer> cartItems){
		   frame = new JFrame() ;	  
	       ...
	       JPanel panel1 = new JPanel(); 
			...
			ImageIcon img2 = new ImageIcon("src/FoodOrdering/CategoriesOfFood/insidemenu/menuitalian.png");
	...
	public void set() {
		price = new HashMap<>();
		price.put("Pasta", 50);
		price.put("Macroni", 100);
		price.put("Spaghetti", 70);
		price.put("Cheese Corn Pizza", 150);
		price.put("Margherita Pizza", 150);
		price.put("Cheeze Burst Pizza", 40);
		
		images.add("src/FoodOrdering/CategoriesOfFood/italian/pasta.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/italian/macroni.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/italian/spaghetti.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/italian/corn.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/italian/margherita.jpeg");
		images.add("src/FoodOrdering/CategoriesOfFood/italian/burst.jpg");
