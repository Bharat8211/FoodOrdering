...
public class Indian extends JFrame {
	...
	JFrame frame;
	public Indian(HashMap<String,Integer> cartItems){
		   frame = new JFrame() ;	  
	       ...
	       JPanel panel1 = new JPanel(); 
			...
			ImageIcon img2 = new ImageIcon("src/FoodOrdering/CategoriesOfFood/insidemenu/indian.png");
 	...
 	public void set() {
		price = new HashMap<>();
		price.put("Paneer Masala", 50);
		price.put("Palak Paneer", 100);
		price.put("Butter Naan", 70);
		price.put("Roti", 150);
		price.put("Daal", 150);
		price.put("Jeera Rice", 40);
		
		images.add("src/FoodOrdering/CategoriesOfFood/indi/mpaneer.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/indi/ppaneer.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/indi/naan.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/indi/roti.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/indi/daal.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/indi/rice.jpg");
