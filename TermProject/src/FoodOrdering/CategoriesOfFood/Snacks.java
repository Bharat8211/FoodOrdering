...
public class Snacks extends JFrame {
	...
	JFrame frame;
	Cart obj;
	public Snacks(HashMap<String,Integer> cartItems){
		   frame = new JFrame() ;	  
		  	 this.obj = obj; 
	       JPanel panel1 = new JPanel(); 
			...
			ImageIcon img2 = new ImageIcon("src/FoodOrdering/CategoriesOfFood/insidemenu/menusnacks.png");
	...
	public void set() {
		price = new HashMap<>();
		price.put("Samosa", 50);
		price.put("Kachori", 100);
		price.put("Chaat", 70);
		price.put("Sandwich", 150);
		price.put("Maggi", 150);
		price.put("Burger", 40);
		
		images.add("src/FoodOrdering/CategoriesOfFood/sncs/samosa.jpeg");
		images.add("src/FoodOrdering/CategoriesOfFood/sncs/kachori.jpeg");
		images.add("src/FoodOrdering/CategoriesOfFood/sncs/chaat.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/sncs/sandwich.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/sncs/maggi.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/sncs/burger.jpg");
