...
public class Desert extends JFrame{
	...
	public Desert(HashMap<String,Integer> cartItems){
		frame = new JFrame() ;	  
	       ...
	       JPanel panel1 = new JPanel(); 
			...
			ImageIcon img2 = new ImageIcon("src/FoodOrdering/CategoriesOfFood/insidemenu/menudesert.png");
	...
	public void set() {
		price = new HashMap<>();
		price.put("Black Forrest Cake", 50);
		price.put("Pineapple Cake", 100);
		price.put("Chocolate Cake", 70);
		price.put("Ice Cream", 150);
		price.put("Brownie", 150);
		price.put("Strawberry Cake", 40);
		
		images.add("src/FoodOrdering/CategoriesOfFood/desserrt/bforest.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/desserrt/brownie.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/desserrt/chococake.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/desserrt/icecream.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/desserrt/pine.jpg");
		images.add("src/FoodOrdering/CategoriesOfFood/desserrt/strw.png");
